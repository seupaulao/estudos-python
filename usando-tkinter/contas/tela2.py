...
class ContasMes:
      ...
      def __init__(self, num_mes, ano, salario, plan):
          ...
          self.contas_mes(self.nmes, self.ano, self.salario, self.plano) 
      ...
      def contas_mes(self, num_mes, ano, salario, outras):
          mes=["Janeiro","Fevereiro","Marco","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"]
          print "-------------------- Mes ", mes[num_mes-1] ," / ", ano," ------------------------"
          print
          self.escreveTexto("Salario ", 40, " ", salario, ":")
          print 
          total_outras = self.calculo_outras(outras) 
          subtotal2 = total_outras
          print  
          self.escreveTexto("Total     ", 40, "-", subtotal2)
          print
          self.calculo_salario_final(salario, subtotal2)
          print    
